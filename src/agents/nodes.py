...
def rerank_node(state: AgentState) -> AgentState:
    """
    Reranking is already handled inside rag_service.retrieve().
    This node is kept for graph compatibility and future custom rerank logic.
    """
    logger.info("rerank_node: reranking already done in rag_service, passing through")
    return state
